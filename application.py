...
def gconnect():
    """
    Handles login with Google- trades authorization code for credentials
    object/ access token and validates. Will create a new user if not
    exists already in database and stores login data in session.
    """
